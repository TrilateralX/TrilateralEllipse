...
var trilateralBasic_AppGL = function(width_,height_) {
	...
	var this1 = this.penNodule.colorTriangles;
	...
	kitGL_glWeb_AnimateTimer.onFrame = function(v) {
		...
		_gthis.gl.drawArrays(4,0,dsHelper_flatInterleave_core_Flat32.get_size(_gthis.penNodule.colorTriangles) * 3 | 0);
	};
};
trilateralBasic_AppGL.__name__ = true;
trilateralBasic_AppGL.prototype = {
	draw: function(pen) {
	}
};
var TrilateralEllipse = function(width,height) {
	...
	trilateralBasic_AppGL.call(this,width,height);
};
TrilateralEllipse.__name__ = true;
TrilateralEllipse.__super__ = trilateralBasic_AppGL;
TrilateralEllipse.prototype = $extend(trilateralBasic_AppGL.prototype,{
	draw: function(pen) {
		...
		while(_g < _g1) {
			var i = _g++;
			this.drawSet(pen,arcs.shift(),pallet,2 * x0,2 * yPos[i],1);
			this.drawSet(pen,arcs.shift(),pallet,2 * x1,2 * yPos[i],1);
		}
	}
	,drawSet: function(pen,arcs,col,x,y,s) {
		var _g = 0;
		var _g1 = arcs.length;
		while(_g < _g1) {
			var i = _g++;
			this.draw_d(pen,arcs[i],x,y,s,5,col[i]);
		}
	}
	,draw_d: function(pen,d,x,y,s,w,color) {
		pen.currentColor = color;
		var sketch = new trilateral3_drawing_Sketch(pen,4,3);
		sketch.width = w;
		var trans = new justPath_transform_ScaleTranslateContext(sketch,x,y,s,s);
		var p = new justPath_SvgPath(trans);
		p.parse(d);
	}
});
function TrilateralEllipse_main() {
	new TrilateralEllipse(1000,1000);
	var divertTrace = new kitGL_glWeb_DivertTrace();
	haxe_Log.trace("TrilateralEllipse example",{ fileName : "TrilateralEllipse.hx", lineNumber : 25, className : "_TrilateralEllipse.TrilateralEllipse_Statics_", methodName : "main"});
}
...
var trilateral3_nodule_PenNodule = function() {
...
trilateral3_nodule_PenNodule.largeEnough = 2000000;
TrilateralEllipse_main();
